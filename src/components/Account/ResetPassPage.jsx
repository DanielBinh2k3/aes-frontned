...
import { auth } from './firebase-config'; // Assuming you have a Firebase configuration file
import Error from '../Elements/Common/Error';
import Success from '../Elements/Common/Success';
        ...
        <div className="p-3 p-md-4 p-xl-5">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="row gy-3 gy-md-4 overflow-hidden">
              ...
              {success && <Success success_msg="Password reset email sent. Please check your inbox." />}
            </div>
          </form>
          <div className="row">
            <div className="col-12">
